...
\begin{verbatim}
git clone git@github.com:dsunder/draft.git
git checkout branch P1505-clause-30-cleanup
cd mandate
git diff master..atomic.tex atomic.tex
\end{verbatim}
\newpage
