...
\pnum
\removed{\requires}\added{\expects}\ \removed{\tcode{F}} \added{\tcode{decay_t<F>}} and each $\tcode{T}_i$ in \removed{\tcode{Args}} \added{\tcode{decay_t<Args>}} \removed{shall} meet the
...
\pnum
\added{\expects \tcode{decay_t<F>} and each $\tcode{T}_i$ in \tcode{decay_t<Args>} meet the
\oldconcept{MoveConstructible} requirements.}
...
\added{\pnum
\expects \tcode{decay_t<F>} and each $\tcode{T}_i$ in \tcode{decay_t<Args>} meet the \oldconcept{MoveConstructible} requirements.}
