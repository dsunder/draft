...
\begin{itemdescr}
\pnum
\removed{\requires}\added{\mandates} \tcode{T} \removed{shall be}\added{is} an object type\added{.}
...
\begin{itemdescr}
\pnum
\removed{\requires}\added{\mandates} T \removed{shall be}\added{is} an object type\added{.}
\removed{, otherwise the program is ill-formed.}
