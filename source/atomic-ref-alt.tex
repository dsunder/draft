...
\begin{addedblock}
\pnum
\mandates If type \tcode{Lock} is equivalent to \tcode{atomic_ref_assume_lock_free_t} 
or \tcode{atomic_ref_assume_no_user_locks} it is possible for the implementation
to either provide lockfree or not require a user provided lock on type \tcode{T} respectively.
\end{addedblock}
\pnum
