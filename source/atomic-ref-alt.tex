...
Many implementations does not support the current specification of \tcode{atomic_ref}
...
implementations to fully support \tcode{atomic_ref} on objects which does not be 
