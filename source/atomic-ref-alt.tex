...
Many implementations cannot support the current specification of \tcode{atomic_ref}
...
implementations to fully support \tcode{atomic_ref} on objects which cannot be 
...
which is at least \tcode{alignof(T)}. \added{If the implementation cannot support
